...
import profilePic from "/Users/alantisgreen/Downloads/AG/src/pages/assets/20220601_171506.jpg";
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            <div className="col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8">
              ...
              <p className="font-medium">
                Hi, I&apos;m Computer Science Student at Wake Forest University, a student  and designer with a
                passion for creating beautiful, functional, and user-centered
                digital experiences. With 3 years of experience in the field. I
                am always looking for new and innovative ways to bring my
                  ideas &apos; visions to life.
              </p>

              <p className="my-4 font-medium">
                I believe working in the technology industry is  about more than just making things 
